...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.fields['password1'].help_text = '<ul class="form-text text-muted"><li><small>Your Password can\'t be too similar to your other personal information.</li><li>Your Password must contain atleast 8 characters.</li><li>Your Password can\'t be commonly used password.</li><li>Your Password can\'t be entirely numeric</li> </small></ul>'
